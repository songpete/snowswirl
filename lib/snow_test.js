...
var snowSwirl = {
  ...
  setSnow: function() {
    ...
    for (i=0; i <= this.snow_count; i++) {
      ...
      snow_flake.style.fontSize = snow_flake.size;
      ...
      snow_flake.style.top = snow_flake.posy;
      snow_flake.style.left = snow_flake.posx;
    }
  },
    ...
    for (i=0; i <= snowSwirl.snow_count; i++) {
      ...
      if (snow_height > snowSwirl.document_height) {
        if (snowSwirl.pile == false) {
          snow_flake.style.top = 0;
        }
      } else {
        snow_flake.style.top = snow_height + snow_flake.random_sink;
